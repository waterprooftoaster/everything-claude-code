Match the existing vault style exactly:

- Bullet-point driven, concise. No fluff, no filler paragraphs.
- Sections are short, for readability and digestibility.
- Sections build chronologically on one another. Define a concept before referencing it. Like writing C without function headers, main goes last.
...
- Most importantly, just read the content and copy the style.
...
Inline definition:
```
- This concept is called ==keyword==.
```
